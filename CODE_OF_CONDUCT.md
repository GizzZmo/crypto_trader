...
* **Being Professional**: Respecting differing viewpoints and experiences
...
* Conducting or promoting illegal activities, including but not limited to market manipulation
* Other conduct which could reasonably be considered inappropriate in a professional setting

## Trading-Specific Guidelines

As this is a cryptocurrency trading bot project, we add these specific guidelines:

### Responsible Trading Discussions

* **Risk Disclosure**: Always emphasize the risks of cryptocurrency trading
* **No Financial Advice**: Don't provide personalized financial advice
* **Educational Focus**: Keep discussions educational and informative
* **No Pump and Dump**: Never coordinate or promote price manipulation
* **Honesty**: Be honest about gains, losses, and limitations of strategies

### Code and Security

* **Security First**: Never share or request API keys or secrets
* **Test Responsibly**: Encourage testing in demo/testnet environments
* **Report Vulnerabilities**: Privately report security issues
* **No Malicious Code**: Never submit code intended to harm users
* **Transparency**: Be clear about what code does, especially with user funds
...
1. Sending a detailed account to the project maintainers
2. Including any evidence that supports your case
3. Remaining respectful throughout the appeal process

Appeals will be reviewed within 7 days, and you will be notified of the decision.
...
This Code of Conduct does not create any legal obligations or liabilities. It is a set of community guidelines. Users of this software are responsible for:
...
The maintainers and contributors of this project are not responsible for any financial losses incurred through the use of this software.
